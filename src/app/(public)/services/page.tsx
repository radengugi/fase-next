...
export default async function ServicesPage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="pt-32 pb-16 bg-[#04045E] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#B9fA3C] mb-6">
            <span className="text-xs text-[#04045E] font-semibold uppercase tracking-widest">Our Services</span>
          </div>
          ...
          {services.length === 0 ? (
            ...
            <>
              <div className="text-center mb-12">
                <h2 className="text-2xl font-bold text-white text-[#0F172A] mb-4">
                  What We Do Best
                </h2>
                <p className="text-white/60 text-black/60 max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {services.map((service) => (
                  <Link
                    ...
                    className="group flex flex-col p-6 rounded-2xl bg-white/[0.06] border border-white/[0.12] hover:bg-white/[0.10] hover:border-[#B9fA3C]/40 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[#B9fA3C]/15"
                  >
                    <div className="relative z-10">
                      <span className="text-3xl mb-4 block">{service.icon}</span>
                      <h3 className="font-semibold text-white text-[#0F172A] text-base mb-2 group-hover:text-[#B9fA3C] transition-colors duration-200">
                        {service.title}
                      </h3>
                      <p className="text-white/40 text-[#0F172A]/50 text-sm leading-relaxed mb-4">
                        {service.description}
                      </p>
                    </div>
      ...
      {/* CTA */}
      <section className="py-32 bg-[#04045E] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-bold text-white text-[#0F172A] mb-6">
            Ready to Start Your{' '}
            <span className="gradient-text">Project?</span>
          </h2>
          <p className="text-xl text-white/60 text-black/60 mb-8 max-w-2xl mx-auto">
