    ...
    <div className="min-h-screen bg-[#04045E]">
      ...
      <section className="pt-32 pb-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <Link href="/services" className="inline-flex items-center gap-2 text-white/50 text-sm mb-8 hover:text-[#B9fA3C] transition-colors">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
            </svg>
            Back to Services
          </Link>
          <h1 className="text-4xl md:text-6xl font-bold text-white text-[#0F172A] mb-6 leading-tight">
            {service.title}
          </h1>
          <p className="text-xl text-white/60 text-black/60 max-w-2xl">
            {service.description}
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#04045E]">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-2xl font-bold text-white text-[#0F172A] mb-6">What We Offer</h2>
          <div className="prose dark:prose-invert max-w-none">
            <p className="text-white/70 text-black/70 text-base leading-relaxed mb-4">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-2xl bg-white/[0.06] border border-white/[0.12]">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-semibold text-white text-[#0F172A]">Expert Team</h3>
              </div>
              <p className="text-white/60 text-black/60 text-sm">Senior specialists with years of experience in {service.title.toLowerCase()}</p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/[0.06] border border-white/[0.12]">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-semibold text-white text-[#0F172A]">Fast Delivery</h3>
              </div>
              <p className="text-white/60 text-black/60 text-sm">Agile methodology with quick turnarounds without compromising quality</p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/[0.06] border border-white/[0.12]">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-semibold text-white text-[#0F172A]">Scalable Solutions</h3>
              </div>
              <p className="text-white/60 text-black/60 text-sm">Built to grow with your business from startup to enterprise</p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-white/[0.06] border border-white/[0.12]">
              <div className="flex items-center gap-3 mb-3">
                ...
                <h3 className="font-semibold text-white text-[#0F172A]">24/7 Support</h3>
              </div>
              <p className="text-white/60 text-black/60 text-sm">Dedicated support and maintenance after project completion</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#04045E]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-white text-[#0F172A] mb-4">
            Ready to Get Started?
          </h2>
          <p className="text-white/60 text-black/60 text-lg mb-8">
      ...
      {allServices.length > 0 && (
        <section className="py-16 bg-[#04045E]">
          <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-2xl font-bold text-white text-[#0F172A] mb-8">More Services</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {allServices.map(srv => (
                ...
                >
                  ...
                  <h3 className="font-semibold text-white text-[#0F172A] text-sm mb-1 group-hover:text-[#B9fA3C] transition-colors">{srv.title}</h3>
                  <p className="text-white/40 text-[#0F172A]/50 text-xs line-clamp-2">{srv.description}</p>
                </Link>
              ))}
            </div>
          </div>
