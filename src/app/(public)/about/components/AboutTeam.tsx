    ...
    <section ref={ref} className="py-24 dark:bg-[#0F172A] bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            <span className="text-xs text-[#B9fA3C] font-semibold uppercase tracking-widest">The Team</span>
          </motion.div>
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            animate={inView ? { opacity: 1, y: 0 } : {}}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {teamMembers.map((member, i) => (
            <motion.div
              ...
              className="group p-6 rounded-2xl dark:bg-white/[0.03] bg-[#F8FAFC] border dark:border-white/[0.06] border-black/[0.06] hover:border-[#B9fA3C]/30 transition-all duration-300 text-center"
            >
